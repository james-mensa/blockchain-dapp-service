...
async function sendEth(signer:number,value:number,_to?:any){
  ...
  try {
    ...
    const etherValue = ethers.utils.parseEther("3");
    await bank.sendEther("0x44890dfF07D190415eA508b137e41dc8643CE41E",{value:etherValue});

    console.log(`${etherValue} transfered to ${"0x44890dfF07D190415eA508b137e41dc8643CE41E"}`);
...
module.exports = {
  ...
  getApprovals,
  getWalletBalance,
  getBalanceWithSignerAsOptional,sendEth
};
