...
export interface ZKGemsERC1155Interface extends utils.Interface {
  functions: {
    "GOLD()": FunctionFragment;
    "_base_uri()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "_base_uri", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "_base_uri", data: BytesLike): Result;
...
export interface ZKGemsERC1155 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZKGemsERC1155Interface;
  ...
  functions: {
    ...
    _base_uri(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    _base_uri(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    _base_uri(overrides?: CallOverrides): Promise<PopulatedTransaction>;
