...
export interface TressureLandNFTInterface extends utils.Interface {
  functions: {
...
export interface TressureLandNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TressureLandNFTInterface;
